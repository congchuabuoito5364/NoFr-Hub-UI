...
local library = {
    ...
    settings = {
        guiname = "Hexagon",
		title = "NoFr Hub [Duoc lam boi Congchuabuoito#5364]",
		logo = "rbxassetid://4350178803", -- "http://www.roblox.com/asset/?id=6597976562",
        footer = " Dit me may bam vao link discord di.",
        modal = true,
    ...
    theme = {
        ...
        textboxtext = Color3.fromRGB(25, 140, 255),
        main = Color3.fromRGB(77, 255, 255),
        outline = Color3.fromRGB(25, 64, 255),
        tabholder = Color3.fromRGB(0, 213, 255),
        tabbutton = Color3.fromRGB(38, 0, 230),
...
function library:Notify(title, message, time, buttons, _function)
	...
	notification.window = library:create("TextLabel", {
		...
		BackgroundColor3 = Color3.fromRGB(77,255,255),
		Text = "",
		Name = "Notification",
		Parent = library.base
	})
	...
	for i,v in pairs(notification.settings.buttons) do
		notification["button"..i] = library:create("TextButton", {
			...
			BackgroundColor3 = Color3.fromRGB(25,64,255),
			Text = v,
			TextSize = 14,
